...
ntry = 10 # number of times to try to get a sentinel band
...
fig, ax = plot_image(os.path.join(intermediate_dir_training, data_dir_S21C), ['516_a.npy', '516_b.npy', '517_a.npy', '517_b.npy'], [4,3,2], titles = ['516_a.npy', '516_b.npy', '517_a.npy', '517_b.npy'], axis=True)
...
fig, ax = plot_image(os.path.join(results_dir_training, data_dir_S21C), ['0_a.npy', '0_b.npy', '1_a.npy', '1_b.npy'], [4,3,2])
